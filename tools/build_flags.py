...
NAME_TO_ISO = {
    ...
    'CAMEROON': 'cm', 'CENTRAL AFRICAN R.': 'cf', 'CHAD': 'td',
    'COMOROS': 'km', 'CONGO': 'cg', 'DR CONGO': 'cd',
    'DJIBOUTI': 'dj', 'EGYPT': 'eg', 'EQ. GUINEA': 'gq',
    ...
    'RWANDA': 'rw', 'SAO TOME': 'st', 'SENEGAL': 'sn',
    ...
    # Americas
    'ANTIGUA': 'ag', 'ARGENTINA': 'ar', 'BAHAMAS': 'bs',
    'BARBADOS': 'bb', 'BELIZE': 'bz', 'BOLIVIA': 'bo', 'BRAZIL': 'br',
    'CANADA': 'ca', 'CHILE': 'cl', 'COLOMBIA': 'co', 'COSTA RICA': 'cr',
    'CUBA': 'cu', 'DOMINICA': 'dm', 'DOM. REPUBLIC': 'do',
    'ECUADOR': 'ec', 'EL SALVADOR': 'sv', 'GRENADA': 'gd',
    'GUATEMALA': 'gt', 'GUYANA': 'gy', 'HAITI': 'ht',
    'HONDURAS': 'hn', 'JAMAICA': 'jm', 'MEXICO': 'mx',
    'NICARAGUA': 'ni', 'PANAMA': 'pa', 'PARAGUAY': 'py', 'PERU': 'pe',
    'ST. KITTS': 'kn', 'ST. LUCIA': 'lc', 'ST. VINCENT': 'vc',
    'SURINAME': 'sr', 'TRINIDAD': 'tt',
    ...
    'MONGOLIA': 'mn', 'MYANMAR': 'mm',
    'NEPAL': 'np', 'NORTH KOREA': 'kp', 'OMAN': 'om', 'PAKISTAN': 'pk',
    'PALESTINE': 'ps', 'PHILIPPINES': 'ph', 'QATAR': 'qa',
    'SAUDI ARABIA': 'sa', 'SINGAPORE': 'sg', 'SOUTH KOREA': 'kr',
    'SRI LANKA': 'lk', 'SYRIA': 'sy', 'TAJIKISTAN': 'tj',
    'THAILAND': 'th', 'TIMOR-LESTE': 'tl', 'TURKEY': 'tr',
    'TURKMENISTAN': 'tm', 'UAE': 'ae',
    ...
    'NETHERLANDS': 'nl', 'N. MACEDONIA': 'mk', 'NORWAY': 'no',
    ...
    'SOLOMON IS.': 'sb', 'TONGA': 'to', 'TUVALU': 'tv', 'VANUATU': 'vu',
}
...
NAME_TO_CONTINENT = {
    ...
    'MOZAMBIQUE': 'AFRICA', 'NAMIBIA': 'AFRICA',
    'NIGER': 'AFRICA', 'NIGERIA': 'AFRICA',
    'RWANDA': 'AFRICA', 'SAO TOME': 'AFRICA', 'SENEGAL': 'AFRICA',
    ...
    'PERU': 'AMERICAS', 'ST. KITTS': 'AMERICAS', 'ST. LUCIA': 'AMERICAS',
    'ST. VINCENT': 'AMERICAS', 'SURINAME': 'AMERICAS',
    'TRINIDAD': 'AMERICAS',
    ...
    'MONTENEGRO': 'EUROPE',
    'NETHERLANDS': 'EUROPE', 'N. MACEDONIA': 'EUROPE', 'NORWAY': 'EUROPE',
