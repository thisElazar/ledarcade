...
class DnD(Game):
    ...
    category = "retro"
    GUIDE = {
        'desc': 'Explore rooms, fight monsters, find quivers and health. Real-time dungeon crawl: move with the joystick, shoot arrows with the button, and keep an eye on your arrow supply.',
