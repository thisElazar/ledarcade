...
PAINTING_META = {
    ...
    "durer_self_portrait": ("Self-Portrait at Twenty-Eight", "Albrecht Durer", 1500),
    ...
    "las_meninas": ("Las Meninas", "Diego Velazquez", 1656),
    "the_swing": ("The Swing", "Jean-Honore Fragonard", 1767),
    ...
    "liberty_leading": ("Liberty Leading the People", "Eugene Delacroix", 1830),
    "death_sardanapalus": ("The Death of Sardanapalus", "Eugene Delacroix", 1827),
    "raft_of_medusa": ("The Raft of the Medusa", "Theodore Gericault", 1819),
    "epsom_derby": ("The Derby at Epsom", "Theodore Gericault", 1821),
    ...
    "olympia": ("Olympia", "Edouard Manet", 1863),
    "bar_folies_bergere": ("A Bar at the Folies-Bergere", "Edouard Manet", 1882),
    ...
    "bathers_asnieres": ("Bathers at Asnieres", "Georges Seurat", 1884),
    "sorolla_seashore": ("Strolling Along the Seashore", "Joaquin Sorolla", 1909),
    ...
    "cafe_terrace": ("Cafe Terrace at Night", "Vincent van Gogh", 1888),
    ...
    "mont_sainte_victoire": ("Mont Sainte-Victoire", "Paul Cezanne", 1887),
    "card_players": ("The Card Players", "Paul Cezanne", 1895),
    ...
    "modigliani_portrait": ("Jeanne Hebuterne", "Amedeo Modigliani", 1919),
