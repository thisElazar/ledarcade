...
PAINTING_META = {
    ...
    "durer_hare": ("Young Hare", "Albrecht Dürer", 1502),
    ...
    "caravaggio_fruit": ("Boy with a Basket of Fruit", "Caravaggio", 1593),
    "caravaggio_musicians": ("The Musicians", "Caravaggio", 1595),
    "gentileschi_self_portrait": ("Self-Portrait as Allegory of Painting", "Artemisia Gentileschi", 1639),
    "vermeer_lacemaker": ("The Lacemaker", "Johannes Vermeer", 1670),
    ...
    "rembrandt_jewish_bride": ("The Jewish Bride", "Rembrandt", 1667),
    "rembrandt_syndics": ("Syndics of the Drapers' Guild", "Rembrandt", 1662),
    ...
    "turner_snowstorm": ("Snow Storm: Steam-Boat off a Harbour's Mouth", "J.M.W. Turner", 1842),
    "turner_norham": ("Norham Castle, Sunrise", "J.M.W. Turner", 1845),
    ...
    "hokusai_waterfall": ("The Amida Falls", "Katsushika Hokusai", 1832),
    ...
    "renoir_two_sisters": ("Two Sisters (On the Terrace)", "Pierre-Auguste Renoir", 1881),
    "renoir_grenouillere": ("La Grenouillère", "Pierre-Auguste Renoir", 1869),
    ...
    "cezanne_apples": ("The Basket of Apples", "Paul Cézanne", 1893),
    "cezanne_curtain": ("Still Life with a Curtain", "Paul Cézanne", 1895),
    "cezanne_red_vest": ("The Boy in the Red Vest", "Paul Cézanne", 1889),
    "cezanne_bibemus": ("Bibémus Quarries", "Paul Cézanne", 1900),
    ...
    "klimt_flower_garden": ("Cottage Garden", "Gustav Klimt", 1907),
    "klimt_farm_garden": ("Farm Garden with Sunflowers", "Gustav Klimt", 1907),
    ...
    "matisse_red_studio": ("The Red Studio", "Henri Matisse", 1911),
    "matisse_open_window": ("Open Window, Collioure", "Henri Matisse", 1905),
    "matisse_woman_hat": ("Woman with a Hat", "Henri Matisse", 1905),
    ...
    "schiele_edith": ("Portrait of Edith", "Egon Schiele", 1915),
    "modigliani_portrait": ("Jeanne Hébuterne", "Amedeo Modigliani", 1919),
    "composition_vii": ("Composition VII", "Wassily Kandinsky", 1913),
    "composition_viii": ("Composition VIII", "Wassily Kandinsky", 1923),
    "several_circles": ("Several Circles", "Wassily Kandinsky", 1926),
    "kandinsky_yellow_red_blue": ("Yellow-Red-Blue", "Wassily Kandinsky", 1925),
    "kandinsky_color_study": ("Color Study: Squares with Concentric Circles", "Wassily Kandinsky", 1913),
    "kandinsky_improvisation": ("Improvisation 28", "Wassily Kandinsky", 1912),
    ...
    "klee_senecio": ("Senecio", "Paul Klee", 1922),
    "klee_castle_sun": ("Castle and Sun", "Paul Klee", 1928),
    "klee_highway": ("Highway and Byways", "Paul Klee", 1929),
    "klee_twittering": ("Twittering Machine", "Paul Klee", 1922),
    "gris_portrait_picasso": ("Portrait of Picasso", "Juan Gris", 1912),
    "gris_tablecloth": ("Still Life with Checked Tablecloth", "Juan Gris", 1915),
    "gris_violin": ("Still Life (Violin and Inkwell)", "Juan Gris", 1913),
    "leger_city": ("The City", "Fernand Léger", 1919),
    "leger_contrast": ("Contrast of Forms", "Fernand Léger", 1913),
    "gleizes_nayral": ("Portrait of Jacques Nayral", "Albert Gleizes", 1911),
    "af_klint_adulthood": ("The Ten Largest, No. 7, Adulthood", "Hilma af Klint", 1907),
    "af_klint_youth": ("The Ten Largest, No. 3, Youth", "Hilma af Klint", 1907),
    "boccioni_city_rises": ("The City Rises", "Umberto Boccioni", 1910),
    "boccioni_farewells": ("States of Mind: The Farewells", "Umberto Boccioni", 1911),
    "lissitzky_wedge": ("Beat the Whites with the Red Wedge", "El Lissitzky", 1919),
    ...
    "goya_colossus": ("The Colossus", "Francisco Goya", 1812),
    "goya_sleep_of_reason": ("The Sleep of Reason Produces Monsters", "Francisco Goya", 1799),
    "titian_pieta": ("Pieta", "Titian", 1576),
    "durer_rhinoceros": ("Rhinoceros", "Albrecht Durer", 1515),
    "durer_melencolia": ("Melencolia I", "Albrecht Durer", 1514),
    "wright_air_pump": ("An Experiment on a Bird in the Air Pump", "Joseph Wright of Derby", 1768),
    "la_tour_newborn": ("The Newborn", "Georges de La Tour", 1648),
    "rembrandt_philosopher": ("Philosopher in Meditation", "Rembrandt", 1632),
    "rembrandt_storm": ("Christ in the Storm on the Sea of Galilee", "Rembrandt", 1633),
    "honthorst_candlelight": ("Musical Group by Candlelight", "Gerrit van Honthorst", 1623),
    "caravaggio_lute_player": ("The Lute Player", "Caravaggio", 1596),
    "la_tour_cheat": ("The Cheat with the Ace of Diamonds", "Georges de La Tour", 1635),
    "wright_orrery": ("A Philosopher Lecturing on the Orrery", "Joseph Wright of Derby", 1766),
    "cellarius_star_atlas": ("Harmonia Macrocosmica", "Andreas Cellarius", 1660),
    "van_gogh_weaver": ("Weaver at the Loom", "Vincent van Gogh", 1884),
    "eakins_chess": ("The Chess Players", "Thomas Eakins", 1876),
    "constable_clouds": ("Cloud Study", "John Constable", 1822),
    "turner_rain_steam": ("Rain, Steam and Speed", "J.M.W. Turner", 1844),
    "turner_parliament": ("The Burning of the Houses of Parliament", "J.M.W. Turner", 1835),
    "blake_newton": ("Newton", "William Blake", 1795),
    "monet_gare": ("Gare Saint-Lazare", "Claude Monet", 1877),
    "durer_jerome": ("St. Jerome in His Study", "Albrecht Durer", 1514),
}
    ...
    def draw(self):
        ...
        if alpha > 0.01:
            ...
            if meta:
                ...
                self._scroll_text(_LINE_Y[0], _strip_accents(title), tc)
                self._scroll_text(_LINE_Y[1], _strip_accents(artist), ac)
