...
RECIPES = [
    ...
    {'name': 'CIABATTA', 'family': 0, 'num': 3,
     'ratio': '100 FLOUR  78 WATER  2 SALT  1 YEAST',
     'bars': [('FLOUR', 100, (220, 180, 120)),
              ('WATER', 78, (80, 140, 255)),
              ('SALT', 2, (240, 240, 240)),
              ('YEAST', 1, (200, 180, 80))],
...
# The 3x5 glyphs are the cabinet's own font. This module once carried a private
# copy that had drifted to 45 glyphs, losing '%' and '=' — the two characters
# baker's percentages are written with — so they drew as blank gaps.
