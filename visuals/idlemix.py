...
_CAT_INFO = {
    ...
    'automata':    ('AUTOMATA',  Colors.MAGENTA),
    'cooking':     ('COOKING',   (120, 160, 100)),
    'digital':     ('DIGITAL',   Colors.CYAN),
    'gallery':     ('GALLERY',   (180, 150, 50)),
    'household':   ('HOUSEHOLD', Colors.ORANGE),
    'math':        ('MATH',      (100, 200, 255)),
    'mechanics':   ('MECHANICS', Colors.PURPLE),
    'music':       ('MUSIC',     (255, 180, 50)),
    'nature':      ('OUTDOORS',  Colors.GREEN),
    'road_rail':   ('ROAD+RAIL', (255, 160, 0)),
    'science':     ('SCIENCE',   Colors.BLUE),
    'sprites':     ('SPRITES',   Colors.LIME),
    'superheroes': ('HEROES',    Colors.RED),
    'titles':      ('TITLES',    (200, 180, 255)),
    'demos':       ('DEMOS',     (255, 100, 100)),
}
