"""
Ms. Pac-Man Demo - AI Attract Mode
==================================
Ms. Pak-Man plays itself using simple AI for idle screen demos.
...
from games.mspacman import MsPacMan


class MsPacManDemo(Visual):
    name = "MS. PAK-MAN"
    description = "AI plays Ms. Pak-Man"
    category = "demos"
    ...
    def reset(self):
        self.time = 0.0
        self.game = MsPacMan(self.display)
        self.game.reset()
        self.ai_dir = (0, 0)
    ...
    def _decide_direction(self):
        """AI decision-making for Ms. Pac-Man movement."""
        game = self.game
