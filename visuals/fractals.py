...
class Fractals(Visual):
    ...
    category = "math"
    GUIDE = {
        'desc': 'Classic fractals rendered in real time: Mandelbrot set, Julia sets, Sierpinski triangle, Koch snowflake, and fractal trees. Left/Right switches fractal, Up/Down cycles the palette.',
        'controls': {
