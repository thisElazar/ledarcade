"""
Green Lantern - Sprite Animation
================================
Classic Green Lantern animation from an animated GIF.
...
class GreenLantern(Visual):
    name = "GREEN LANTERN"
    description = "In brightest day"
    category = "superheroes"

    GIF_FILE = "greenlantern.gif"
    BASE_INTERVAL = 0.06
    ...
    def _load_gif(self):
        """Load GIF frames, crop to center square, and scale to 64x64."""
        if not HAS_PIL:
            return
