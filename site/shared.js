...
class Display {
  ...
  // Lowercase and symbols, matching Display.draw_text_raw on the cabinet.
  ...
  // Marquee text: x may be negative and glyphs may be cut mid-column.
  drawTextClipped(x, y, text, color, x0, x1) {
    text = text.toUpperCase();
    for (let cx = Math.max(x0, 0); cx < Math.min(x1, GRID); cx++) {
      const px = cx - x;
      if (px < 0) continue;
      const charIdx = Math.floor(px / 4), col = px % 4;
      if (col >= 3 || charIdx >= text.length) continue;
      const glyph = FONT[text[charIdx]];
      if (!glyph) continue;
      for (let r = 0; r < 5; r++)
        if ((glyph[r] >> (2 - col)) & 1) this.setPixel(cx, y + r, color);
    }
  }
}

const FONT = {
  " ":[0,0,0,0,0],"!":[2,2,2,0,2],"\"":[5,5,0,0,0],"#":[2,7,2,7,2],
  "$":[3,6,2,3,6],"%":[5,1,2,4,5],"&":[2,5,2,5,3],"'":[2,2,0,0,0],
  "(":[1,2,2,2,1],")":[4,2,2,2,4],"*":[0,5,2,5,0],"+":[0,2,7,2,0],
  ",":[0,0,0,2,4],"-":[0,0,7,0,0],".":[0,0,0,0,2],"/":[1,2,2,2,4],
  ...
  "@":[3,5,7,4,3],"A":[2,5,7,5,5],"B":[6,5,6,5,6],"C":[3,4,4,4,3],
  "D":[6,5,5,5,6],"E":[7,4,6,4,7],"F":[7,4,6,4,4],"G":[3,4,5,5,3],
  "H":[5,5,7,5,5],"I":[7,2,2,2,7],"J":[1,1,1,5,2],"K":[5,6,4,6,5],
  "L":[4,4,4,4,7],"M":[5,7,7,5,5],"N":[5,7,7,7,5],"O":[2,5,5,5,2],
  "P":[6,5,6,4,4],"Q":[2,5,5,6,3],"R":[6,5,6,5,5],"S":[3,4,2,1,6],
  "T":[7,2,2,2,2],"U":[5,5,5,5,3],"V":[5,5,5,2,2],"W":[5,5,7,7,5],
  "X":[5,5,2,5,5],"Y":[5,5,2,2,2],"Z":[7,1,2,4,7],"^":[2,5,0,0,0],
  "_":[0,0,0,0,7],"a":[0,3,5,5,3],"b":[4,4,6,5,6],"c":[0,3,4,4,3],
  "d":[1,1,3,5,3],"e":[0,2,7,4,3],"f":[1,2,6,2,2],"g":[0,3,5,3,6],
  "h":[4,4,6,5,5],"i":[2,0,2,2,2],"j":[2,0,2,2,4],"k":[4,5,6,6,5],
  "l":[6,2,2,2,2],"m":[0,0,7,7,5],"n":[0,0,6,5,5],"o":[0,0,2,5,2],
  "p":[0,6,5,6,4],"q":[0,3,5,3,1],"r":[0,0,3,4,4],"s":[0,3,2,2,6],
  "t":[2,2,7,2,3],"u":[0,0,5,5,3],"v":[0,0,5,5,2],"w":[0,0,5,7,7],
  "x":[0,0,5,2,5],"y":[0,5,5,3,6],"z":[0,0,7,2,7],"~":[0,0,3,6,0],
};
